...
static void InitColors(void)
{
    ...
    DefineColor("Color1",0.996,0.547,0.41);
    DefineColor("Color2",0.18,0.543,0.34);
    DefineColor("Color3",0.8,0.8,0);
    DefineColor("Color4",0.53,0.8,0.98);
	DefineColor("Color5",0.996,0.41,0.27);
	DefineColor("Color6",0,0.535,0.566);
	DefineColor("Color7",0,0.77,0.8);
	DefineColor("Color8",0.773,0.883,0.996);
	DefineColor("Color9",0.937,0.969,0.996);
	DefineColor("ColorBack",0.996,0.996,0.5625);
}
